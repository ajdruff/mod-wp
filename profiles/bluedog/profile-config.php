...
$config[ 'add_custom_content' ] = 1; //Add the custom content specified under the 'Custom Content' section
...
$config[ 'allow_search_engines' ] = 0; //Allow Search Engines to Crawl Site
...
$config[ 'wp_config' ][ 'WP_DEBUG' ] = true; #default 0
$config[ 'wp_config' ][ 'WP_DEBUG_DISPLAY' ] = true; #default 0
$config[ 'wp_config' ][ 'WP_DEBUG_LOG' ] = true; #default 0
...
$config[ 'remove_file_cruft' ] = 1; //removes license.txt,readme,etc from web root.
...
$config[ 'remove_default_themes' ] = 1; //remove default WordPress themes
...
$config[ 'wp_options' ][ 'medium_size_w' ] = 300; #default 300
