...
$profile[ 'add_custom_content' ] = 0; //Add the custom content specified under the 'Custom Content' section
...
$profile[ 'allow_search_engines' ] = 1; //Allow Search Engines to Crawl Site
...
$profile[ 'wp_config' ][ 'WP_DEBUG' ]= 0; #default 0
$profile[ 'wp_config' ][ 'WP_DEBUG_DISPLAY' ] = 0; #default 0
$profile[ 'wp_config' ][ 'WP_DEBUG_LOG' ] = 0; #default 0
...
$profile[ 'remove_file_cruft' ] = 0; //removes license.txt,readme,etc from web root.
...
$profile[ 'remove_default_themes' ] = 0; //remove default WordPress themes
...
$profile[ 'wp_options' ][ 'medium_size_w' ] = 301; #default 300
 ...
 * the 'About the BueDog Installer' as its parent.
 * ********************************* */

//an example of a preinstalled post.
$profile[ 'posts' ][ 0 ][ 'title' ] = "BlueDog Installer";
$profile[ 'posts' ][ 0 ][ 'status' ] = "publish"; #Status (publish, draft, etc...). Default : draft;
$profile[ 'posts' ][ 0 ][ 'type' ] = "post"; #Post Type. Default : post;
$profile[ 'posts' ][ 0 ][ 'slug' ] = "bluedog-installer-welcome"; #Slug;
$profile[ 'posts' ][ 0 ][ 'parent' ] = ""; #Parent page Title;
$profile[ 'posts' ][ 0 ][ 'content' ] = "Thanks for installing WordPress using the BlueDog WP Installer!"; #Content (HTML allowed);
//an example of a preinstalled post.
...
$profile[ 'posts' ][ 1 ][ 'parent' ] = "BlueDog Installer"; #Parent page Title;
$profile[ 'posts' ][ 1 ][ 'content' ] = "This content was automatically added when WordPress was installed using the BlueDog Installer. If you don't want this content, re-install setting \$profile['add_custom_content']=false. To modify edit the config.php and look for the 'Custom Default Content' section.";

//an example of a preinstalled page.
$profile[ 'posts' ][ 2 ][ 'title' ] = "About the BlueDog Installer";
...
$profile[ 'posts' ][ 3 ][ 'parent' ] = "About the BlueDog Installer"; #Parent page Title;
