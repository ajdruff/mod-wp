...
$profile[ 'posts' ][ 1 ][ 'content' ] = "This content was automatically added when WordPress was installed using the BlueDog Installer. If you don't want this content, re-install setting \$profile['add_custom_content']=false. To modify it, edit the profile-config.php file and look for the 'Custom Content' section.";
